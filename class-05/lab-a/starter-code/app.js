...
function sumArray(sumArr) { //eslint-disable-line
    ...
    let sentence = `${testArray} was passed in as an array of numbers, and ${answer} is their sum.`;
...
function multiplyArray(multArr) { //eslint-disable-line
    let answer2 = multiply(multiply(testArray[0],testArray[1])[0],testArray[2])[0];
    let sentence2 = `The numbers ${testArray} have a product of ${answer2}.`;
    console.log([answer2,sentence2]);
    return[answer2,sentence2];
}
